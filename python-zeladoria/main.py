...
# CORS — lê origens permitidas do ambiente; fallback inclui dev local e Railway
_raw_origins = os.environ.get(
    "ALLOWED_ORIGINS",
    "http://localhost:5173,http://localhost:8001,http://localhost:3000,"
    "https://zeladoria-backend-production.up.railway.app"
)
_allowed_origins = [o.strip() for o in _raw_origins.split(",") if o.strip()]

app.add_middleware(
    CORSMiddleware,
    allow_origins=_allowed_origins,        # lista explícita — jamais ["*"] com credentials
